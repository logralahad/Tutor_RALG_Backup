            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <c:if test="${rolToEdit != null}">
                    ...
                    <div class="row justify-content-center">
                        <div class="col">
                            <form
                                action="<%=request.getContextPath()%>/Rol/actualizar/${rolToEdit.getId()}">
                                <div class="mb-3 row">
                                    <label for="nombre"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control"
                                            name="descripcion"
                                            value="${rolToEdit.getDescripcion()}">
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="col-3">
                                        <button type="submit"
                                            class="btn btn-primary mb-3 w-100">Guardar</button>
                                    </div>
